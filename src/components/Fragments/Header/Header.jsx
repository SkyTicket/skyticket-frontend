...
<p className="py-6 text-2xl font-semibold text-black">{title}</p>
        <div className="flex items-center gap-6">
          <Link
            to="/"
            className={`my-2 flex w-full items-center gap-4 rounded-xl bg-[#A06ECE] px-4 py-3 text-white`}
          >
          ...
          {rightButtonIcon && (
            <button
              ...
              className="flex h-fit items-center gap-3 rounded-full border border-[#7533b2] bg-transparent p-2 px-3 text-[#A06ECE] hover:bg-[#f6edff] dark:border"
            >
