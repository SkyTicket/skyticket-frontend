  ...
  return (
    <>
      <input
        ...
        className="w-[60%] cursor-pointer border-[#D0D0D0] bg-white py-4 text-lg font-medium text-black placeholder-gray-300 focus:outline-none lg:w-80 lg:border-b-2 lg:py-2"
